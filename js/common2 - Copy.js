...
var playerInfoList = [{id:'player',videoId:'Cau7jiqqtRc'},{id:'cp_IJNR2EpS0jw',videoId:'IJNR2EpS0jw'},{id:'cp_amhtkloe06k',videoId:'amhtkloe06k'}];
...
function onYouTubeIframeAPIReady() {
	...
	*/
	...
	/*
	$('div.customplayer').click(function(){
		var t = new YT.Player($(this).attr('id'), {
			videoId: $(this).attr('vid'),
			width: "100%",
			height:"100%",			
			autoplay: 1,
            events: {
...
function onPlayerStateChange(event) {
    if (event.data == YT.PlayerState.PLAYING) {
        ...
        //var tempPlayers = $("div.customplayer");
...
function onPlayerReady(event) {
  ...
  //event.target.playVideo();
	...
	// bind events
	$("#about_play").click(function(e) {
    $(".about-video-wrapper").addClass("show");
		players[0].playVideo();
  });
  
  var aboutPauseButton = document.getElementById("about_close");
...
/*---------- CLASSIE ----------*/
(function(h){function g(a,b){(c(a,b)?d:e)(a,b)}var c,e,d;"classList"in document.documentElement?(c=function(a,b){return a.classList.contains(b)},e=function(a,b){a.classList.add(b)},d=function(a,b){a.classList.remove(b)}):(c=function(a,b){return(new RegExp("(^|\\s+)"+b+"(\\s+|$)")).test(a.className)},e=function(a,b){c(a,b)||(a.className=a.className+" "+b)},d=function(a,b){a.className=a.className.replace(new RegExp("(^|\\s+)"+b+"(\\s+|$)")," ")});var f={hasClass:c,addClass:e,removeClass:d,toggleClass:g,
has:c,add:e,remove:d,toggle:g};"function"===typeof define&&define.amd?define(f):"object"===typeof exports?module.exports=f:h.classie=f})(window);
...
(function() {
	...
	var bodyEl = document.body,
		...
		gridEl = document.getElementById('manifestos'),
		gridItemsContainer = gridEl.querySelector('.manifestos-list'),
		contentItemsContainer = gridEl.querySelector('.articles'),
		gridItems = gridItemsContainer.querySelectorAll('li'),
...
function setVideoSize() {
	$("#videos .poster").each(function() {
			var $this = $(this);
			$this.closest(".video-holder").height($this.height());
			$this.closest(".video-holder").find("iframe").height($this.height());
	});
}
...
$(document).ready(function(){
	$('a[href*=\\#]:not([href=\\#])').bind('touchstart click', function() {
		if (location.pathname.replace(/^\//,'') === this.pathname.replace(/^\//,'') && location.hostname === this.hostname) {
			...
			if (target.length) {
				...
				if($(window).width() > 570 && $(window).width() <= 1100){
	...
	/*--- MOBILE MENU ---*/
	$('.mobile-menu-btn').bind('touchstart click', function(e){
		$("body").addClass("menu-open");
		$("#mobile_nav_wrapper").scrollTop(0);	
		return false;
	});
	
	$("#content_mask, .menu-close").bind('touchstart click', function(e){
		$("body").removeClass("menu-open");
		return false;
	});
